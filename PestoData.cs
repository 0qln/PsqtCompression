...
namespace PsqtCompression.Data
{
    ...
    internal class Pesto
    {
        ...
        public static short[,] HalfJaggedTables = new short[2, 6 * 64]
        {
            {
               82,    82,    82,    82,    82,    82,    82,    82,
              180,   216,   143,   177,   150,   208,   116,    71,
        ...
        public static short[,,] FullJaggedTables = new short[2, 6, 64]
        {
            {
                {
                   82,    82,    82,    82,    82,    82,    82,    82,
        ...
        public static short[] ShortPositionTables = new short[64 * 6 * 2]
        {
            // mg
          0,   0,   0,   0,   0,   0,  0,   0,
